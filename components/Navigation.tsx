...
export const Navigation = () => {
  ...
  return <><a className="skip-link" href="#main-content">Skip to content</a><nav className="site-nav" aria-label="Main navigation">
    ...
    <div className={`nav-links ${open ? 'open' : ''}`} id="main-navigation">
      <NavLink to="/" end>About / vision</NavLink><NavLink to="/explore">City explorer</NavLink><NavLink to="/journeys">Daily journeys</NavLink><NavLink to="/infrastructure">How it works</NavLink><NavLink to="/feasibility">Project brief</NavLink>
    </div>
