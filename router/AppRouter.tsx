...
function LocationEffects() {
  ...
  useEffect(() => {
    document.title = `${pathname === '/' ? 'About the proposal' : pathname === '/explore' ? 'City explorer' : pathname === '/infrastructure' ? 'How the city works' : 'Project brief'} | Rotunda`;
